...
GlobalVariable.password = randomString(chars, 10)

WebUI.setText(findTestObject('Object Repository/Кейклоак/Новый пароль'), GlobalVariable.password)

WebUI.setText(findTestObject('Object Repository/Кейклоак/Повторите пароль'), GlobalVariable.password)
